...
check_token() {
  ...
  if [ "$USER_TOKEN" = "warungbekicot" ]; then
...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/XstyanzZx/xyroku/main/C2.zip")
        break
        ;;
      2)
...
# Unduh file tema
wget -O /root/C2.zip https://github.com/XstyanzZx/xyroku/main/C2.zip
